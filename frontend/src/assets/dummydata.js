...
export const stats = [
    {
        ...
        label: 'Deliveries',
        icon: GiFoodTruck,
        gradient: 'from-cyan-500 via-orange-400 to-yellow-600',
    },
    {
        number: '98%',
        label: 'Satisfaction',
        icon: FaHeart,
        gradient: 'from-rose-500 via-cyan-500 to-yellow-500',
    },
    {
        number: '500+',
        label: 'Cities',
        icon: FaLeaf,
        gradient: 'from-emerald-500 via-cyan-500 to-yellow-600',
    },
    {
        number: '24/7',
        label: 'Support',
        icon: FaRegClock,
        gradient: 'from-cyan-500 via-orange-400 to-rose-500',
    },
];
...
export const aboutfeature = [
    { icon: FaBolt, title: "Instant Ordering", text: "Seamless digital experience", color: "from-cyan-400 to-orange-500" },
...
export const addButtonBase = "flex items-center gap-2 bg-gradient-to-r from-red-600 to-cyan-600 text-white px-5 py-2.5 rounded-xl font-bold border-2 border-cyan-400/30";
export const addButtonHover = "hover:gap-3 hover:shadow-lg hover:shadow-cyan-500/30 active:scale-95 relative overflow-hidden";
...
// LOGIN 
export const inputBase = "w-full rounded-lg bg-[#2D1B0E] text-cyan-100 placeholder-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-600";
export const iconClass = "absolute top-1/2 transform -translate-y-1/2 left-3 text-cyan-400";
